...
const char *reg_to_str(int reg) {
  ...
  case (0x08):
    return "REG_FRF_LSB";
  case (0x09):
    return "REG_PA_CONFIG";
  case (0x0c):
    return "REG_LNA";
  case (0x0d):
    return "REG_FIFO_ADDR_PTR";
  case (0x0e):
    return "REG_FIFO_TX_BASE_ADDR";
  case (0x0f):
    return "REG_FIFO_RX_BASE_ADDR";
  case (0x10):
    return "REG_FIFO_RX_CURRENT_ADDR";
  case (0x12):
    return "REG_IRQ_FLAGS";
  case (0x13):
    return "REG_RX_NB_BYTES";
  case (0x19):
    return "REG_PKT_SNR_VALUE";
  case (0x1a):
    return "REG_PKT_RSSI_VALUE";
  case (0x1d):
    return "REG_MODEM_CONFIG_1";
  case (0x1e):
    return "REG_MODEM_CONFIG_2";
  case (0x20):
    return "REG_PREAMBLE_MSB";
  case (0x21):
    return "REG_PREAMBLE_LSB";
  case (0x22):
    return "REG_PAYLOAD_LENGTH";
  case (0x26):
    return "REG_MODEM_CONFIG_3";
  case (0x2c):
    return "REG_RSSI_WIDEBAND";
  case (0x31):
    return "REG_DETECTION_OPTIMIZE";
  case (0x37):
    return "REG_DETECTION_THRESHOLD";
  case (0x39):
    return "REG_SYNC_WORD";
  case (0x40):
    return "REG_DIO_MAPPING_1";
  case (0x42):
    return "REG_VERSION";
  }
  return "";
...
int lora_read_reg(int reg) {
  ...
  ESP_LOGD("lora", "from reg %d - %s read %d", reg, reg_to_str(reg), in[1]);
